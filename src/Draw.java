...
public class Draw extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		for (RoadNode node : world.intersections)
		{
			...
			if (node.connections[0] == null && node.connections[1] == null && node.connections[2] == null
					&& node.connections[3] == null)
				g2d.drawImage(street1[0][0], node.x * 16, node.y * 16, null);
			else if (node.connections[0] == null && node.connections[1] == null && node.connections[2] == null
					&& node.connections[3] != null)
			...
			else // (node.connections[0] != null && node.connections[1] != null
					// && node.connections[2] != null && node.connections[3] !=
					// null)
				g2d.drawImage(street1[3][3], node.x * 16, node.y * 16, null);
			// g2d.drawImage(street1[3][3], node.x * 16, node.y * 16, null);
			// g2d.drawImage(trafficLight[0], node.x * 16 , node.y * 16 , null);
